...
int main(int argc, char **argv)
{
    ...
    tubule_pose.position.x = 0.6;
    tubule_pose.position.y = -0.1;
    ...
    // 90 degree rotation around y axis to grab it from the side
    ...
    ROS_INFO("Fume hood: Sending pose goal message. Content is:");
