...
int main(int argc, char **argv)
{
    ...
    tubule_pose.position.x = -0.67;
    tubule_pose.position.y = 0.45;
    tubule_pose.position.z = 0.46;
    ...
    pose_goal_msg.pick_tubule.data = false;

    //Whether we want to grab the tubule from the side or from top
    pose_goal_msg.grab_from_top.data = true;

    ROS_INFO("Get centrifuge: Sending pose goal message.");
